...
export function MentorAssignmentHub() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      <ManagerPageHeader
        title="Đăng ký lớp"
        description="Quản lý kỹ năng, tìm lớp Bản nháp đã có lịch — mở panel để theo dõi yêu cầu đã gửi."
      >
        <Button
          type="button"
        ...
        <section className="min-w-0 flex-1">
          ...
          <div className="border-b border-border bg-card px-4 py-3 lg:px-6">
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">
              Lớp Bản nháp đã xếp lịch và lớp đã xin / đã nhận xếp chung — ưu tiên hiện
