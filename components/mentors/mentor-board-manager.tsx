  ...
  return (
    <div className={cn("flex min-h-full flex-col", embedded && "min-h-0")}>
      {embedded ? null : (
        <ManagerPageHeader
          title="Bảng lớp"
          description="Lớp Bản nháp đã có lịch, chưa có mentor — và lớp bạn đã xin / đã nhận."
        />
      )}
      ...
      <div className={cn("flex-1 py-6", embedded ? "px-4 lg:px-6" : "px-6")}>
        {isLoading && listEmpty ? (
          ...
          <ManagerEmptyState
            ...
            description="Thử đổi bộ lọc hoặc quay lại sau khi có lớp Bản nháp đã xếp lịch."
