/** Shared Select styling for light and dark surfaces across the app. */
...
export const LIGHT_SELECT_CONTENT_PANEL =
  "rounded-xl border-[#E5E5E0] bg-white text-[#2D2D2D]";

export const LIGHT_SELECT_ITEM_PANEL = "rounded-lg focus:bg-[#F5F5F0]";
