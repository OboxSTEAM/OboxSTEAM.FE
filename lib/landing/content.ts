  ...
  features: [
    {
      ...
      body: "Ảnh lớp học được AI gắn đúng từng học viên. Bằng chứng học tập vào portfolio mà không cần chọn tay từng khuôn mặt.",
    ...
    },
    {
      ...
      body: "Footage chung của buổi học được cắt thành clip 9:16 của từng em. Phụ huynh xem nhanh; hồ sơ du học có đoạn phim thật từ lớp.",
    ...
    },
    {
      ...
      body: "Nhật ký học tập thô được viết lại thành đoạn văn rõ ý. Học viên giữ giọng mình; mentor và hồ sơ nhận được bản đã trau chuốt.",
    ...
    },
    {
      ...
      body: "Mỗi học viên có một địa chỉ tên.obox.id. Chia sẻ microsite bất cứ lúc nào — không cần xuất PDF mới cho từng lần nộp.",
