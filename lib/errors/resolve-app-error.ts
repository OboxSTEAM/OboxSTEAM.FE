...
const CONTEXT_FALLBACKS: Record<AppErrorContext, AppErrorState> = {
  ...
  "frameworks.detail": {
    title: "Không tải được chi tiết khung",
    reason: "Khung chương trình có thể đã bị xóa.",
    action: "Quay lại danh sách khung và thử lại.",
  },
  "frameworks.create": {
  ...
  "frameworks.update": {
    ...
    reason: "Thông tin chưa hợp lệ hoặc khung không còn tồn tại.",
    action: "Tải lại danh sách, kiểm tra thông tin rồi lưu lại.",
  },
  "frameworks.delete": {
  ...
  "coteach.list": {
    title: "Không tải được danh sách chuyên gia đồng hành",
    reason: "Máy chủ tạm thời không phản hồi hoặc kết nối bị gián đoạn.",
    action: "Thử tải lại sau vài giây.",
  },
  "coteach.invite": {
    title: "Không mời được chuyên gia",
    reason: "Chuyên gia đã được mời hoặc buổi học không hợp lệ để mời.",
    action: "Kiểm tra lại buổi học và danh sách chuyên gia rồi thử lại.",
  },
  "coteach.accept": {
    title: "Không nhận được lời mời",
    reason: "Lời mời có thể đã bị thu hồi hoặc đã được xử lý.",
    action: "Tải lại danh sách lời mời và thử lại.",
  },
  "coteach.decline": {
    title: "Không từ chối được lời mời",
    reason: "Lời mời có thể đã bị thu hồi hoặc đã được xử lý.",
    action: "Tải lại danh sách lời mời và thử lại.",
  },
  "coteach.withdraw": {
    title: "Không thu hồi được lời mời",
    reason: "Lời mời có thể đã được xử lý hoặc buổi học đã diễn ra.",
    action: "Tải lại danh sách và thử lại.",
  },
  "coteach.feedback": {
    title: "Không lưu được nhận xét buổi học",
    reason: "Buổi học chưa hoàn thành hoặc nhận xét chưa hợp lệ.",
    action: "Nhập nhận xét và điểm đánh giá 1–5 rồi gửi lại.",
  },
  "programs.lifecycle": {
    title: "Không đổi được trạng thái chương trình",
    reason: "Chương trình chưa đủ điều kiện chuyển trạng thái hoặc đã được xử lý.",
    action: "Tải lại trang và kiểm tra trạng thái hiện tại rồi thử lại.",
  },
  "classes.list": {
